...
function Technology() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Technologies we work on</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">We work on a variety of technologies only after researching their capability to scale and integrate with other evolving technologies that could implement the use cases.</p>
    </div>
    <div class="flex flex-wrap -m-4 text-center">
      ...
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        ...
        <img 
          ...
          src={Ethereum} />
          <p class="leading-relaxed">Enterprise and public Ethereum blockchain</p>
        </div>
      </div>
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">

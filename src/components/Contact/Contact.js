      ...
      <div className='container px-5 py-24 mx-auto'>
        <div className='flex flex-col text-center w-full'>
          ...
          <p className='lg:w-3/3 mx-auto leading-relaxed text-base'>
            Our team builds best possible solution on
            various platforms such as Ethereum, Hyperledger, R3 Corda. Have a look at the services and products that we work on.
